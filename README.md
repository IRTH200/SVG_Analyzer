# Sticky Afrohead SVG Decoder

**Uncover The Hidden Poison**

A universal SVG malware decoder designed for threat research and hunting. Automatically detects and decrypts multiple encryption variants used in SVG-based phishing/credential theft campaigns.
...
```bash
python3 sticky_afrohead_decoder.py malware.svg          # Full analysis
python3 sticky_afrohead_decoder.py malware.svg --raw    # Decoded payload only
python3 sticky_afrohead_decoder.py malware.svg -o report.txt  # Save report
```
