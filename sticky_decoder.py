#!/usr/bin/env python3
"""
Sticky Afrohead - SVG Malware Decoder
...
Author: Sticky Afrohead
Team: Threat Research and Hunting Team
Version: 3.0
"""
...
__version__ = "3.0"
__author__ = "Sticky Afrohead"
__team__ = "Threat Research and Hunting Team"
...
{Colors.END}
    {Colors.CYAN}════════════════════════════════════════════════════════════════════════════════
    {Colors.WHITE}SVG Decoder - Uncover The Hidden Poison{Colors.CYAN}
    {Colors.YELLOW}Threat Research and Hunting Team{Colors.CYAN}
    {Colors.WHITE}Version: {__version__}{Colors.CYAN}
    ════════════════════════════════════════════════════════════════════════════════{Colors.END}
""")
...
# ============================================================================
# TYPE 1: SIMPLE XOR DECODER (like "secretkey" samples)
# ============================================================================
...
# ============================================================================
# TYPE 2: LCG + FEISTEL DECODER (data-t/data-* samples)
# ============================================================================
...
# ============================================================================
# TYPE 3: DNA ENCODING + FIBONACCI XOR DECODER (xlink:href Base64 samples)
# ============================================================================
...
# ============================================================================
# TYPE 4: BASE64 + DUAL-KEY XOR DECODER (concatenated key samples)
# ============================================================================
...
def main():
    parser = argparse.ArgumentParser(
        description=f'Sticky Afrohead SVG Decoder - {__tagline__}',
